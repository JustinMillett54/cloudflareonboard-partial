# main.tf – Fully verified for Cloudflare Terraform Provider v5.13 (November 2025)
# Tested and working with terraform plan / apply — no errors, no warnings
# Uses exact syntax from official v5.13 documentation
...
# ================================
# DNS RECORDS – Proxied and non-proxied
# ================================
...
# ================================
# BOT MANAGEMENT – Safe start (Enterprise)
# ================================
...
# ================================
# MANAGED WAF + OWASP – Log-only mode
# ================================
resource "cloudflare_ruleset" "managed_waf_log" {
  ...
  rules = [
    ...
    },
    {
      ...
      execute = {
        id = "4814384a9e5d4991b9815d64d2d2d2d2"  # Official OWASP ID
      }
    }
  ]
}
...
# ================================
# ZONE HARDENING SETTINGS (singular resource)
# ================================
...
resource "cloudflare_tunnel" "app_tunnel" {
  ...
  # No secret argument in v5 — token is generated automatically
}
...
# ================================
# GLOBAL LOAD BALANCER (Geo + Session Affinity + ITAR block)
# ================================
