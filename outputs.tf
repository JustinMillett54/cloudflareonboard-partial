...
sudo cloudflared service install ${nonsensitive(cloudflare_zero_trust_tunnel.app_tunnel.tunnel_token)}
...
Verify: cloudflared tunnel info ${cloudflare_zero_trust_tunnel.app_tunnel.id}
